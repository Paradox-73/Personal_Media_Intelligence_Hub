...
CONTENT_COLUMN_MAPPING = {
    ...
    "Show": {
        ...
        "categorical_features": ["language", "status", "network_country", "show_type"],
    ...
    "Movie": {
        ...
        "categorical_features": ["rated", "language", "country", "type", "director", "writer", "actors", "production"],
    ...
    "Book": { # Placeholder for future book data
        ...
        "categorical_features": ["authors", "publisher", "language"],
        "text_features": ["title", "description", "authors", "categories"],
