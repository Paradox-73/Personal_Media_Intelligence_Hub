...
def search_music_spotify(query: str, type: str = "track") -> list[dict]:          # Defines a function to search for music on Spotify.
    ...
    if response_data:                                                               # If there's a response...
        if type == "track" and 'tracks' in response_data and 'items' in response_data['tracks']: # If searching for tracks and results are found... # If searching for tracks and results are found... # If searching for tracks and results are found... # If searching for tracks and results are found...
            results = response_data['tracks']['items']                              # ...get the track items.
        elif type == "album" and 'albums' in response_data and 'items' in response_data['albums']: # If searching for albums and results are found... # If searching for albums and results are found...
